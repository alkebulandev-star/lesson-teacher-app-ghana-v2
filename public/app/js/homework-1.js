...
async function startExamSession(){
  ...
  if (cfg.level === 'primary'){
    levelNote = 'IMPORTANT: These questions are for PRIMARY 6 level (ages 10-11) for the National NSMQ Practice Examination into Federal Unity Colleges. Use very simple, clear language a 10-year-old can read. Use small numbers, familiar contexts (school, home, market, playground). No trick questions.';
